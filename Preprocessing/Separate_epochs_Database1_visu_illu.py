...
BdfFolder=r'/Volumes/Volume/EPFL/Projets/PdM/RawData_visu'
...
ResAfterInt=r'/Volumes/Volume/EPFL/Projets/PdM/EPH/visu_illu'
...
##        Tva=np.int64(np.float64(np.array(cf.Tva(Tva).Data)))
        ...
        Events=np.concatenate([BdfData.MrkTime[BdfData.MrkTrig==Trig_illu1], BdfData.MrkTime[BdfData.MrkTrig==Trig_illu2]])
