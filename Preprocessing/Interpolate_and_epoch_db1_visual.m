...
raw_path='/Users/mip/Documents/PdM/Data/BDFs/Database1_visual';
...
for subj=1:size(Subj_names,1)
    ...
    files = {files.name}';  
    count_epo(1:2)=1;  % nb of accepted epochs
    count_rej(1:2)=1;  % nb of rejected epochs
...
%             save('base_resampled.mat','base_resampled','-v7.3');
            ...
            clearvars -except count_epo count_rej bdf subj c_dir files Subj start_i Nelec sr filt_order high_cf low_cf sr_new task ic nic OutDir raw_path chan_names EEG Subj_names Bad_elec
            close all
    end
end
